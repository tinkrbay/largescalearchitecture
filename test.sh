...
read rdsreadreplica
echo -n "Input the EFS DNS name followed by :/ e.g. efs-dns-name:/ [ENTER]:"
read efsdnsname
...
echo ""$efsdnsname"	/var/www/html/blogs/wp-content/uploads/	nfs4	nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,_netdev,noresvport	0	0" >> /etc/fstab
sudo mount -a
cd /home/ec2-user/
